...
option(USE_BRAINSFitEZ                    "Build BRAINSFitEZ"                    OFF)
option(USE_BRAINSROIAuto                  "Build BRAINSROIAuto"                  OFF)
option(USE_BRAINSResample                 "Build BRAINSResample"                 OFF)
option(USE_BRAINSDemonWarp                "Build BRAINSDemonWarp "               OFF)
option(USE_GTRACT                         "Build GTRACT"                         OFF)
option(USE_BRAINSABC                      "Build BRAINSABC"                      OFF)
option(USE_BRAINSTransformConvert         "Build BRAINSTransformConvert"         OFF)
option(USE_BRAINSConstellationDetector    "Build BRAINSConstellationDetector"    ON)
option(USE_BRAINSMush                     "Build BRAINSMush"                     OFF)
option(USE_BRAINSInitializedControlPoints "Build BRAINSInitializedControlPoints" OFF)
option(USE_BRAINSMultiModeSegment         "Build BRAINSMultiModeSegment"         OFF)
option(USE_BRAINSCut                      "Build BRAINSCut"                      OFF)
option(USE_BRAINSLandmarkInitializer      "Build BRAINSLandmarkInitializer"      OFF)
option(USE_ImageCalculator                "Build ImageCalculator"                OFF)
option(USE_BRAINSSnapShotWriter           "Build BRAINSSnapShotWriter"           OFF)
